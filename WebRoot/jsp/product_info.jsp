		 ...
		 <form id="myForm" action="${pageContext.request.contextPath}/CartServlet?method=addCartItemToCart" method="post">
			<div class="row">
				<div style="border: 1px solid #e4e4e4;width:930px;margin-bottom:10px;margin:0 auto;padding:10px;margin-bottom:10px;">
					...
					<a href="${pageContext.request.contextPath}/">书籍&nbsp;&nbsp;&gt;</a>
					<a>书籍详情</a>
				</div>

				<div style="margin:0 auto;width:950px;">
					<div class="col-md-6">
						<img style="opacity: 1;width:400px;height:350px;" title="" class="medium" src="${pageContext.request.contextPath}/${allCats.pimage}">
					</div>
                      
					<div class="col-md-6">
						<div><strong>${product.pname }</strong></div>
						<div style="border-bottom: 1px dotted #dddddd;width:350px;margin:10px 0 10px 0;">
							<div>编号：${allCats.pid}</div>
						</div>

						<div style="margin:10px 0 10px 0;">市场价: <strong style="color:#ef0101;">￥:${allCats.market_price}元/本</strong> 参 考 价： <del>￥${allCats.shop_price}/本</del>
						</div>
						...
						<div style="margin:10px 0 10px 0;">促销: <a target="_blank" title="限时抢购 (2014-07-30 ~ 2015-01-01)" style="background-color: #f07373;">限时抢购</a> </div>
							...
							<div style="border-bottom: 1px solid #faeac7;margin-top:20px;padding-left: 10px;">购买数量:
                               ...
                               <!-- 向服务器发送pid  -->
                                <input type="hidden" name="pid" value="${allCats.pid }">
							<div style="margin:20px 0 10px 0;;text-align: center;">
								...
								<a href="javascript:;">
									...
									value="加入购物车" id="btn" type="button">
								</a> &nbsp;收藏商品</div>
						</div>
					</div>
				...
				<div style="width:950px;margin:0 auto;">
					...
					<div>
						<img src="${pageContext.request.contextPath}/${allCats.pimage}">
					</div>
                        <%-- 
					<div style="background-color:#d3d3d3;width:930px;padding:10px 10px;margin:10px 0 10px 0;">
						<strong>商品参数</strong>
