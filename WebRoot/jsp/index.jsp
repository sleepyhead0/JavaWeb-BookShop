...
<html>
	...
	<body>
		...
		<%@ include file="/jsp/heder.jsp" %>
			...
			<div class="container-fluid">
				<div class="col-md-12">
					<h2>热门书籍&nbsp;&nbsp;<img src="${pageContext.request.contextPath}/img/title2.jpg"/></h2>
				</div>
				 ...
				 --%>
					...
					<div class="col-md-3" style="text-align:center;height:200px;padding:10px 0px;">
						<a href="${pageContext.request.contextPath}/ProductServlet?method=finProductId&pid=${b.pid}">
							<img src="${pageContext.request.contextPath}/${b.pimage}" width="130" height="130" style="display: inline-block;">
						</a>
						<p><a href="${pageContext.request.contextPath}/ProductServlet?method=finProductId&pid=${b.pid}" style='color:#666'>${b.pname }</a></p>
						<p><font color="#E4393C" style="font-size:16px">&yen;${b.shop_price } </font></p>
					</div>
					</c:forEach>
	               </div>
			</div>
			...
			<div class="container-fluid">
				<div class="col-md-12">
					<h2>最新书籍&nbsp;&nbsp;<img src="${pageContext.request.contextPath}/img/title2.jpg"/></h2>
				</div>
				<div class="col-md-2" style="border:1px solid #E7E7E7;border-right:0;padding:0;">
					<img src="products/hao/big01.jpg" width="205" height="404" style="display: inline-block;"/>
				</div>
				...
				<%-- 
					...
					--%>
				      <c:forEach items="${allCats1 }" var="b">
					<div class="col-md-3" style="text-align:center;height:200px;padding:10px 0px;">
						<a href="${pageContext.request.contextPath}/ProductServlet?method=finProductId&pid=${b.pid}">
							<img src="${pageContext.request.contextPath}/${b.pimage}" width="130" height="130" style="display: inline-block;">
						</a>
