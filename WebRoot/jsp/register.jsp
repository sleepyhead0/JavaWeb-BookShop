	...
	<div class="col-md-8" style="background:#fff;padding:40px 80px;margin:30px;border:7px solid #ccc;">
		...
		<form class="form-horizontal" style="margin-top:5px;" action="${pageContext.request.contextPath }/UserServlet?method=userRegist" method="post">
			 <div class="form-group">
			    ...
			    <div class="col-sm-6">
			      <input type="text" class="form-control" name="username" id="username1" placeholder="请输入用户名">
			    </div>
			  </div>
			   <div class="form-group">
			...
			<label class="radio-inline">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-2">
			    <img src="${pageContext.request.contextPath}/img/Code.jpg" width="70px" height="30px"/>
			    </div>
