...
public class MailUtils {
	...
	public static void sendMail(String email, String emailMsg)
		...
		String url="http://localhost:8080/BookShop1733/UserServlet?method=active&code="+emailMsg;
		String content="<h1>来自图书商城的激活邮件!激活请点击以下链接!</h1><h3><a href='"+url+"'>"+url+"</a></h3>";
		//设置邮件内容
